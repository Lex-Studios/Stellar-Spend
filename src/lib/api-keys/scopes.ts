...
const routeScopeEntries: RouteScopeEntry[] = [
  {
    method: "GET",
    pathPattern: /^\/api\/v1\/offramp\/quote/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/offramp\/quote/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/v1\/offramp\/quote-aggregate/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/offramp\/quote-aggregate/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/v1\/offramp\/fees/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/offramp\/fees/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/v1\/offramp\/rate/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/offramp\/rate/,
    requiredScope: "read:quotes",
  },

  {
    method: "POST",
    pathPattern: /^\/api\/v1\/offramp\/execute-payout/,
    requiredScope: "write:payouts",
  },
  {
    method: "POST",
    pathPattern: /^\/api\/offramp\/execute-payout/,
    requiredScope: "write:payouts",
  },
  {
    method: "POST",
    pathPattern: /^\/api\/v1\/offramp\/paycrest\/order/,
    requiredScope: "write:payouts",
  },
  {
    method: "POST",
    pathPattern: /^\/api\/offramp\/paycrest\/order/,
    requiredScope: "write:payouts",
  },

  {
    method: "GET",
    pathPattern: /^\/api\/v1\/offramp\/status/,
    requiredScope: "read:transactions",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/offramp\/status/,
    requiredScope: "read:transactions",
  },
  {
    method: "GET",
  ...
  {
    method: "GET",
    pathPattern: /^\/api\/v1\/offramp\/reconciliation/,
    requiredScope: "read:transactions",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/offramp\/reconciliation/,
    requiredScope: "read:transactions",
  },

  {
    method: "GET",
    pathPattern: /^\/api\/v1\/offramp\/currencies/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/offramp\/currencies/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/v1\/offramp\/institutions/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/offramp\/institutions/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/v1\/offramp\/verify-account/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/offramp\/verify-account/,
    requiredScope: "read:quotes",
  },

  {
    method: "GET",
    pathPattern: /^\/api\/v1\/fx-rates/,
    requiredScope: "read:quotes",
  },
  {
    method: "GET",
    pathPattern: /^\/api\/fx-rates/,
    requiredScope: "read:quotes",
  },
];
...
export function hasRequiredScope(
  ...
  if (
    apiKey.scopes.includes("admin:*" as any) ||
    apiKey.scopes.includes("admin" as any)
  ) {
    return true;
  }

  const [requiredAction, requiredResource] = requiredScope.split(":") as [
    ScopeAction,
    ScopeResource,
  ];
  ...
  for (const assignedScope of apiKey.scopes) {
    ...
    const [assignedAction, assignedResource] = assignedScope.split(":") as [
      ScopeAction,
      ScopeResource,
    ];
    ...
    if (
      assignedAction === requiredAction &&
      assignedResource === requiredResource
    )
      return true;

    if (assignedResource === "*" && assignedAction === requiredAction)
      return true;
    if (assignedAction === "*" && assignedResource === requiredResource)
      return true;
  }
