...
export const dal: DAL = {
  async save(transaction: Transaction): Promise<void> {
    ...
    try {
      ...
      throw new DatabaseError(`Failed to save transaction: ${(err as Error).message}`, err);
    }
  },
  ...
  async update(id: string, updates: Partial<Transaction>): Promise<void> {
    ...
    try {
      ...
      throw new DatabaseError(`Failed to update transaction ${id}: ${(err as Error).message}`, err);
    }
  },
  ...
  async getById(id: string): Promise<Transaction | null> {
    ...
    try {
      ...
      throw new DatabaseError(`Failed to get transaction ${id}: ${(err as Error).message}`, err);
    }
  },
