...
describe("calculateBridgeFee", () => {
  ...
  it("throws for zero amount", () => {
    expect(() => calculateBridgeFee("0", "stablecoin")).toThrow(
      "Invalid amount",
    );
  });

  it("throws for negative amount", () => {
    expect(() => calculateBridgeFee("-50", "stablecoin")).toThrow(
      "Invalid amount",
    );
  });

  it("throws for non-numeric string", () => {
    expect(() => calculateBridgeFee("abc", "stablecoin")).toThrow(
      "Invalid amount",
    );
  });
});
...
describe("calculateAmountAfterFees", () => {
  ...
  it("throws for non-numeric amount", () => {
    expect(() => calculateAmountAfterFees("abc", "1")).toThrow(
      "Invalid amounts",
    );
  });

  it("throws for non-numeric fee", () => {
    expect(() => calculateAmountAfterFees("100", "abc")).toThrow(
      "Invalid amounts",
    );
  });
});
