...
- [ ] 2. Implement the dashboard layout in `page.tsx`
  - [ ] 2.1 Wire up OuterContainer, InnerSection, and grid container
  ...
  - [ ] 2.2 Place components in correct grid positions
...
- [ ] 4. Write unit tests for layout structure
  - [ ] 4.1 Set up test file and render helpers
